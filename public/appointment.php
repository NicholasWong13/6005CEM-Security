		...
		<?php
            ...
            if(isset($_POST['submit_book_appointment_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try
                {
					...
					{
						$stmtgetCurrentClientID = $con->prepare("SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'studio c hair & beauty salon' AND TABLE_NAME = 'clients'");
                    ...
                    $stmtgetCurrentAppointmentID = $con->prepare("SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'studio c hair & beauty salon' AND TABLE_NAME = 'appointments'");
          ...
          <div class="row">
                <div class="col-sm-2 col-md-12">
                    <div class="content">
                        ...
                        <p>Get the Fresher Styles & Cuts For Your Needs along with any Hair Services Or Treatment.</p>
                        <h2>For Help Call: +6016-412 1820</h2>
                    </div>
                </div>
