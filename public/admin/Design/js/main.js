...
/*
    ...
    SERVICE CATEGORIES PAGE ==== > DELETE SERVICE CATEGORY BUTTON IS CLICKED
...
/*
    ...
    Contact Us PAGE ==== > DELETE Contact Us BUTTON IS CLICKED

    ========================================
*/


 $('.delete_contact_bttn').click(function()
{
    var id = $(this).data('id');
    var do_ = "Delete";
    ...
    $.ajax(
    {
        url:"ajax_files/contactus_ajax.php",
        method:"POST",
        data:{id:id,do:do_},
        success: function (data) 
        {
