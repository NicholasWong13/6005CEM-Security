<?php
	...
	// ELSE
	$pageTitle = 'Studio C Hair & Beauty Salon Admin Login';
	include 'connect.php';
...
<html lang="en">
	<head>
		...
		<title>Studio C Admin Login</title>
		<!-- FONTS FILE -->
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; Studio C Hair & Beauty Salon 2022</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
